...
class TestTrustGatePipelineIntegration:
    def test_trust_gate_is_step_13(self):
        ...
        assert steps[14].name == "Trust Gate Evaluation"
    ...
    def test_step_always_included_gates_internally(self):
        ...
        assert isinstance(steps_tl1[14], TrustGateStep)
        assert len(steps_tl5) == 16
        assert isinstance(steps_tl5[14], TrustGateStep)
