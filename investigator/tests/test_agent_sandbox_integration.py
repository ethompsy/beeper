...
class TestSandboxExecutorPipelineIntegration:
    def test_sandbox_executor_is_step_9(self):
        ...
        assert steps[9].name == "Sandbox Test Execution"
    ...
    def test_step_always_included_gates_internally(self):
        ...
        assert isinstance(steps_tl1[9], SandboxExecutorStep)
        assert len(steps_tl5) == 14
        assert isinstance(steps_tl5[9], SandboxExecutorStep)
